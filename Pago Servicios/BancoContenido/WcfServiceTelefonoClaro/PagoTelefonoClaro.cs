...
namespace WcfServiceTelefonoClaro
{
    // NOTA: puede usar el comando "Rename" del menú "Refactorizar" para cambiar el nombre de clase "Service1" en el código y en el archivo de configuración a la vez.
    public class PagoTelefonoClaro : IPagoTelefonoClaro
    {

        public static string coneccion = "Server = ADRIANCS\\AJCSSERVER; database = TelefonoClaro; Trusted_Connection = true";
        ...
        string IPagoTelefonoClaro.montopago(string medidor)
        {
