...
namespace WcfServiceTelefonoKolbi
{
    // NOTA: puede usar el comando "Rename" del menú "Refactorizar" para cambiar el nombre de clase "Service1" en el código y en el archivo de configuración a la vez.
    public class PagoTelefonoKolbi : IPagoTelefonoKolbi
    {

        public static string coneccion = "Server = ADRIANCS\\AJCSSERVER; database = Telefonokolbi; Trusted_Connection = true";
        ...
        string IPagoTelefonoKolbi.montopago(string medidor)
        {
