...
namespace WcfServiceAguaMunicipalidad
{
    ...
    public class PagoAguaMuni : IPagoAguaMuni
    {

        public static string coneccion = "Server = ADRIANCS\\AJCSSERVER; database = AguaMunicipalidad; Trusted_Connection = true";
        ...
        string IPagoAguaMuni.montopago(string medidor)
        {
