...
namespace WcfServiceAguaAsada
{
    // NOTA: puede usar el comando "Rename" del menú "Refactorizar" para cambiar el nombre de clase "Service1" en el código y en el archivo de configuración a la vez.
    public class PagoAguaAsada : IPagoAguaAsada
    {
                public static string coneccion = "Server = ADRIANCS\\AJCSSERVER; database = AguaAsada; Trusted_Connection = true";
        ...
        string IPagoAguaAsada.montopago(string medidor)
        {
